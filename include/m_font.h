...
#define mFont_FONT_TEX_WIDTH 384
#define mFont_FONT_TEX_HEIGHT 512
...
extern void mFontSentence_set(mFontSentence* this, u8* sentence_p, int len, u32 flags, xy_t* pos, int line_type,
                              xy_t* scale, rgba_t* color, int se_voice_pos, u8 voice_idx, u8 voice2_idx, u8 voice3_idx,
...
extern int mFont_Get_FontOffset(u8 c);
extern void mFont_Debug_ChangeOffset(int amount);
extern void mFont_Debug_AdjustFontOffset(int amount);
extern int mFont_Debug_GetIdx(void);
