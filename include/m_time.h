...
enum { mTM_RENEW_TIME_BEGIN = 0, mTM_RENEW_TIME_WEATHER = mTM_RENEW_TIME_BEGIN, mTM_RENEW_TIME_DAILY };
...
#define mTM_CheckCmpYMDEqual(ymd0, ymd1) \
    ((ymd0)->year == (ymd1)->year && (ymd0)->month == (ymd1)->month && (ymd0)->day == (ymd1)->day)
#define mTM_CheckCmpYMDClear(ymd0)                                                                           \
    ((ymd0)->year == mTM_rtcTime_ymd_clear_code.year || (ymd0)->month == mTM_rtcTime_ymd_clear_code.month || \
     (ymd0)->day == mTM_rtcTime_ymd_clear_code.day)
