...
#define GAME_YEAR_MAX 2100 /* Maximum year supported by the game */
...
enum RTC_EQUALITY { lbRTC_LESS = -1, lbRTC_EQUAL = 0, lbRTC_OVER = 1 };
...
enum RTC_EQUALITY_FLAGS {
    ...
    /* 0x7F */
    lbRTC_CHECK_ALL = lbRTC_CHECK_SECONDS | lbRTC_CHECK_MINUTES | lbRTC_CHECK_HOURS | lbRTC_CHECK_WEEKDAYS |
