...
custom_rel_yml = c.load_from_yaml(f"{c.CONFIG}/rel_custom.yml")
if custom_rel_yml["custom_tus"] != None and len(custom_rel_yml) > 0:
    load_custom_tus(custom_rel_yml["custom_tus"], c.REL_CTX, rel_sources)
